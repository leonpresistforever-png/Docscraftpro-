  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] font-sans text-dc-text pt-24">
      ...
      <main className="w-full max-w-[1000px] mx-auto px-6 py-12">
        <h1 className="text-4xl md:text-5xl font-black mb-8 uppercase tracking-tight text-[#1a1a1a]">Careers</h1>
        <div className="bg-white p-8 rounded-2xl border border-[#E4DBC5] shadow-sm">
           <h2 className="text-2xl font-black text-[#1a1a1a] mb-4">Join the Team</h2>
           <p className="text-gray-600 mb-6 leading-relaxed">
             We're looking for passionate individuals to help us build the future of document engineering. Check back soon for open roles!
           </p>
        </div>
      </main>
